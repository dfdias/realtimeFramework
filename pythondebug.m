...
% ================================================================
th = linspace(0,2*pi,200);
%%load comparision matrix
debug = load(filename_g)
...
for nf= 1:Nframes_f,
    ...
    % ================================================================
   %error analysis
   debug_signal = debug.s(nf,:)';
   debug_g = debug.g(nf,:)';
   debug_d1 = debug.d1(nf,:)';
   debug_d = debug.d(nf,:)';
   debug_rx = debug.rx(nf,:)';
   err_signal = s_f-debug_signal
   err_g = g -debug_g
