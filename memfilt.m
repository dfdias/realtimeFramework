...
df = buff.get() ;%obtem as frames ordenadas do buffer circular
[f,x,y] = fit_correct(df',x_past,y_past,a1,a2,false);%aplicação de circle fit filtro e correção do arco
